...
<head>
<title>PROKER SEKSI IX - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Pendidikan Teknologi Informasi </span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='gps2011'){
				include("include/gps2011.php");
