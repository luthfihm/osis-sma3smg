...
<head>
<title>SUBSIE SEKSI IV - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='pengabdianmasyarakat'){
				include("include/pengabdianmasyarakat.php");
			}else if($mn=='kpskapa'){
				include("include/kpskapa.php");
			}else if($mn=='pmr'){
				include("include/pmr.php");
			}	
			//---------------------------------------
		}else{
			include("include/pmr.php");
