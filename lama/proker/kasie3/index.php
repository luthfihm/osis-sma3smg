...
<head>
<title>PROKER SEKSI III - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Pendidikan Pendahuluan Bela negara</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='gaputagogreen'){
				include("include/gaputagogreen.php");
			}else if($mn=='gebyarganesha'){
				include("include/gebyarganesha.php");
			}else if($mn=='lpbb2011'){
				include("include/lpbb2011.php");
			}	
			//---------------------------------------
		}else{
			include("include/lpbb2011.php");
