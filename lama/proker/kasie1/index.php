...
<head>
<title>PROKER SEKSI I - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Ketaqwaan Terhadap Tuhan YME</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='ifest'){
				include("include/ifest.php");
			}else if($mn=='lpa2011'){
				include("include/lpa2011.php");
			}
			//---------------------------------------
		}else{
			include("include/ifest.php");
