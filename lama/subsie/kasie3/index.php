...
<head>
<title>SUBSIE SEKSI III - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='gaputa'){
				include("include/gaputa.php");
			}else if($mn=='pas'){
				include("include/pas.php");
			}else if($mn=='paskibar'){
				include("include/paskibar.php");
			}else if($mn=='pks'){
				include("include/pks.php");
			}else if($mn=='ssc'){
				include("include/ssc.php");
			}	
			//---------------------------------------
		}else{
			include("include/pks.php");
