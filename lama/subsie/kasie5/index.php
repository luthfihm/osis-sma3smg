...
<head>
<title>SUBSIE SEKSI V - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='fdi'){
				include("include/fdi.php");
			}else if($mn=='mosibio'){
				include("include/mosibio.php");
			}else if($mn=='mosifisika'){
				include("include/mosifisika.php");
			}else if($mn=='mosikimia'){
				include("include/mosikimia.php");
			}else if($mn=='mosimat'){
				include("include/mosimat.php");
			}	
			//---------------------------------------
		}else{
			include("include/fdi.php");
