...
<head>
<title>SUBSIE SEKSI VIII - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='band'){
				include("include/band.php");
			}else if($mn=='gpw'){
				include("include/gpw.php");
			}else if($mn=='iss'){
				include("include/iss.php");
			}else if($mn=='karawitan'){
				include("include/karawitan.php");
			}else if($mn=='md'){
				include("include/md.php");
			}else if($mn=='sinematografi'){
				include("include/sinematografi.php");
			}else if($mn=='teater'){
				include("include/teater.php");
			}else if($mn=='ansambel'){
				include("include/ansambel.php");
			}	
			//---------------------------------------
		}else{
			include("include/gpw.php");
