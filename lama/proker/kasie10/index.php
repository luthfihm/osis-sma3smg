...
<head>
<title>PROKER SEKSI X - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Bahasa</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='ganeshainenglish'){
				include("include/ganeshainenglish.php");
			}else if($mn=='moe'){
				include("include/moe.php");
			}else if($mn=='jsoulmatsuri4'){
				include("include/jsoulmatsuri4.php");
			}else if($mn=='pelatihanjurnalistik'){
				include("include/pelatihanjurnalistik.php");
			}	
			//---------------------------------------
		}else{
			include("include/pelatihanjurnalistik.php");
