...
<head>
<title>PROKER OSIS - SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Organisasi Siswa Intra Sekolah (OSIS)</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='muri2011'){
				include("include/muri2011.php");
			}else if($mn=='prs'){
				include("include/prs.php");
			}else if($mn=='widyawisata'){
				include("include/widyawisata.php");
			}
			//---------------------------------------
		}else{
			include("include/widyawisata.php");
