...
<head>
<title>PENGURUS - OSIS SMA NEGERI 3 SEMARANG</title>
...
<body id="page1" onload="showclock();MM_preloadImages('images/pengurusover.png')">
<div id="main">
<div class="top_bg">
  <!-- header -->
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='0001'){
				include("include/0001.php");
			}else if($mn=='0102'){
				include("include/0102.php");
			}else if($mn=='0203'){
				include("include/0203.php");
			}else if($mn=='0304'){
				include("include/0304.php");
			}else if($mn=='0405'){
				include("include/0405.php");
			}else if($mn=='0506'){
				include("include/0506.php");
			}else if($mn=='0607'){
				include("include/0607.php");
			}else if($mn=='0708'){
				include("include/0708.php");
			}else if($mn=='0809'){
				include("include/0809.php");
			}else if($mn=='0910'){
				include("include/0910.php");
			}else if($mn=='1011'){
				include("include/1011.php");
			}else if($mn=='1112'){
				include("include/1112.php");
			}	
			//---------------------------------------
		}else{
			include("include/1011.php");
