...
<head>
<title>PROKER SEKSI V - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Berorganisasi, Pendidikan Politik, dan Kepemimpinan</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='lks2osis'){
				include("include/lks2osis.php");
			}	
			//---------------------------------------
		}else{
			include("include/lks2osis.php");
