...
<head>
<title>SUBSIE SEKSI I - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='rohis'){
				include("include/rohis.php");
			}else if($mn=='doc'){
				include("include/doc.php");
			}else if($mn=='pelita'){
				include("include/pelita.php");
			}else if($mn=='hindu'){
				include("include/hindu.php");
			}else if($mn=='budha'){
				include("include/budha.php");
			}	
			//---------------------------------------
		}else{
			include("include/rohis.php");
