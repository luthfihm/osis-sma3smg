...
<head>
<title>SUBSIE SEKSI VII - OSIS SMA NEGERI 3 SEMARANG</title>
...
<script type="text/javascript" src="../../staff/expandCollapse.js"></script>
...
<div class="top_bg">
  ...
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='atletik'){
				include("include/atletik.php");
			}else if($mn=='badminton'){
				include("include/badminton.php");
			}else if($mn=='gasoca'){
				include("include/gasoca.php");
			}else if($mn=='gfc'){
				include("include/gfc.php");
			}else if($mn=='basket'){
				include("include/basket.php");
			}else if($mn=='volley'){
				include("include/volley.php");
			}else if($mn=='kempo'){
				include("include/kempo.php");
			}else if($mn=='tenismeja'){
				include("include/tenismeja.php");
			}else if($mn=='freestyle'){
				include("include/freestyle.php");
			}else if($mn=='pd'){
				include("include/pd.php");
			}else if($mn=='ggc'){
				include("include/ggc.php");
			}else if($mn=='tenislapangan'){
				include("include/tenislapangan.php");
			}	
			//---------------------------------------
		}else{
			include("include/gasoca.php");
