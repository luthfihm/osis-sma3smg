<?
	...
	$sub=$_POST['subsie'];
	if($sub!="null"){
	$view=$op->cs_query("SELECT * FROM tb_subsie WHERE id=$sub");
...
.popup {
 ...
 <div id="judul_page"> <img src="../image/point.png" border="0" align="absmiddle" /> Edit Profil <? echo $dt['nama_subsie'] ?></div><br />
 <form action="main_menu.php?view=e_subsie" method="post">
 <input type="hidden" name="subsie" id="subsie" value="<? echo $dt['id']; ?>" />
 <table valign="center" cellpadding="1" cellspacing="1" border="0">
 <tr><td>Nama Subsie</td><td>:</td><td><input type="text" name="nama" size="62" value="<? echo $dt['nama_subsie']; ?>"  /></td></tr>
 <tr><td>Title Menu</td><td>:</td><td><input type="text" name="title" size="62" value="<? echo $dt['title']; ?>"  /></td></tr>
 <tr><td>Kasubsie</td><td>:</td><td><input type="text" name="kasubsie" size="62" value="<? echo $dt['kasubsie']; ?>"  /></td></tr>
	...
	<tr><td valign="top">Content</td><td valign="top">:</td><td><textarea name="content" cols="70" rows="20"><? echo $dt['profil']; ?></textarea>
	</td></tr>
