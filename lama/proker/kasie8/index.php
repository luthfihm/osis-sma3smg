...
<head>
<title>PROKER SEKSI VIII - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Persepsi, Apreasiasi dan Kreasi Seni</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='asdmp'){
				include("include/asdmp.php");
			}else if($mn=='cinemact'){
				include("include/cinemact.php");
			}else if($mn=='moviecamp'){
				include("include/moviecamp.php");
			}else if($mn=='cinemact2011'){
				include("include/cinemact2011.php");
			}else if($mn=='muspus2011'){
				include("include/muspus2011.php");
			}else if($mn=='pensaga2011'){
				include("include/pensaga2011.php");
			}else if($mn=='bazaar2011'){
				include("include/bazaar2011.php");
			}	
			//---------------------------------------
		}else{
			include("include/cinemact2011.php");
