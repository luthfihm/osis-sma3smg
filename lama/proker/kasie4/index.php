...
<head>
<title>PROKER SEKSI IV - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Kepribadian dan Budi Perkerti Luhur</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='kartiniganesha'){
				include("include/kartiniganesha.php");
			}	
			//---------------------------------------
		}else{
			include("include/kartiniganesha.php");
