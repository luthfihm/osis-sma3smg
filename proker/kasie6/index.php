...
<head>
<title>PROKER SEKSI VI - OSIS SMA NEGERI 3 SEMARANG</title>
...
<div class="top_bg">
  ...
  <div class="col_2">
    <div class="boxstaff margi20 ">
        <div align="center"><span class="titlesubsie2">Seksi Keterampilan dan Kewiraswastaan</span></div><br />
  <?php
		if(isset($_REQUEST['page'])){
			$mn=$_REQUEST['page'];
			if($mn=='p10g'){
				include("include/p10g.php");
			}	
			//---------------------------------------
		}else{
			include("include/p10g.php");
